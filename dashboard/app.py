...
# ============================================================
# DYNAMIC PATH SETUP – no hardcoded drive letters
# ============================================================
BASE_DIR = Path(__file__).resolve().parent
ASSETS_DIR = BASE_DIR / "assets"
VIDEO_PATH = ASSETS_DIR / "industrial-bg.mp4"

# Allow Gradio to serve files from the assets folder
gr.set_static_paths(paths=[ASSETS_DIR])

# Build the correct Gradio API URL for the video
...
# ===== FIX: Safe Arduino initialisation =====
...
/* =========================================================
   UNIFIED STYLING FOR LOGS AND PRODUCTION CORE (no double gradient)
   ========================================================= */
...
/* =========================================================
   IMPROVED TEXT CONTRAST FOR GLASS SURFACES
   ========================================================= */
...
with gr.Blocks() as demo:
    # --- FULL‑SCREEN BACKGROUND VIDEO (with correct Gradio 4+ URL) ---
    gr.HTML(
        f"""
    ...
    # Third Row - System Logs and Production Core (unified styling)
    with gr.Row():
        with gr.Column(scale=1):
            with gr.Group(elem_classes="system-logs-container"):
